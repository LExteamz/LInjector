    ...
    <Vector3 name="InitialSize">
    	...
    	<Z>999</Z>
				...
				elseif Type == "PhysicalProperties" then
					if Objp then
						Append = '<PhysicalProperties name="'
							.. ObjProp
							.. '"><CustomPhysics>true</CustomPhysics>'
							.. "<Density>"
							.. tostring(Objp.Density)
							.. "</Density>"
							.. "<Friction>"
...
local FileData = ""
for Step, string in Final do
	FileData ..= string

	if (Step % 1080) == 0 then
		Beat:wait()
		warn(`{Step / #Final * 100}% completed...`)
	end
end

writefile(Place .. ".rbxl", FileData)
print(Place .. ".rbxl")

warn(`Saved to {Place .. ".rbxl"}! Took: {tick() - Timer} second(s). \
Please check your workspace folder`)
